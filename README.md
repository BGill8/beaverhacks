...
What it does
Our app specifically works by giving the user the ability to record audio in their surroundings, typically a lecture, and the app transcribes it to text and then uses that text with an AI to understand it an return to the user a summary and detailed notes of the audio provided.
How we built it
